...
###########################################################
#                                                         #
# This script updates tle TLE data for Meteor-M2 4        #
# and writes it into the file ~/.predict/predict.tle      #
#                                                         #
# The source of the TLE data is Celestrak:                #
# https://celestrak.org/NORAD/elements/gp.php?CATNR=59051 #
#                                                         #
###########################################################
...
while true; do
    tle=`curl https://celestrak.org/NORAD/elements/gp.php?CATNR=59051`

    if [[ -z $(grep "METEOR-M2 4" ~/.predict/predict.tle) ]]; then
        ...
        start_line=`grep -n "METEOR-M2 4" ~/.predict/predict.tle | grep -o -E '[0-9]+' | head -n1`
